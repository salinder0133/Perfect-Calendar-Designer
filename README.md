...
🔗 **[Live Demo](https://salinder0133.github.io/Perfect-Calendar-Designer/)** 
...
### 🎨 Visual Styles
Choose from 4 stunning pre-built themes:
- **💎 Glass Modern:** Frosted glass effect with blur.
- **✨ Luxury Gold:** Elegant gold borders and light backgrounds.
...
### 🗓️ Calendar Modes
1.  **Single Month Mode:** Focus on a specific month with a large photo background.
2.  **Full Year Mode:** Generates a complete 12-month calendar grid (Supports years up to 2030 with holiday logic).

### 💾 Export & Download
- **Download as PDF:** Generates a high-quality A4 PDF ready for printing.
- **Download as JPG:** Saves the calendar as a high-resolution image file.
